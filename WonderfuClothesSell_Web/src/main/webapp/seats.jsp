...
// 			lightbox
			function reservationHandler(e){
				e.preventDefault();
				$.ajax({
					url: $("#reservationDetails").attr("action"), 
					method: $("#reservationDetails").attr("method"),
					data: $("#reservationDetails").serialize()
				}).done(reservationAjaxHandler);
			}
			function reservationAjaxHandler(response){

				$("#getReservation").html(response);
				openLightboxForReservation();
			}
			function openLightboxForReservation(){
				 document.getElementById("lightboxForReservation").style.display = "block";
				 setTimeout(function(){document.getElementById("lightboxForReservation").style.opacity = 1;},50);
			}
			function closeLightboxForReservation(){
			    document.getElementById("lightboxForReservation").style.opacity = 0;
			    setTimeout(function(){document.getElementById("lightboxForReservation").style.display = "none";},300);
			}
...
// 			lightbox
	...
	<body>
		<div id="lightboxForReservation" class="lightboxForReservationClass">
	 		<div class="closelightboxForReservation" onclick="closeLightboxForReservation()"> &times;</div>
	 		<div id='getReservation' class="lightboxForReservationContent"></div>
		</div>
